...
<div id="dcHead">
	<div id="head">
		<div class="logo">
			<a href="index.php"><img src="${pageContext.request.contextPath}/resources/images/dclogo.png" alt="logo"></a>
		</div>
		<div class="nav">
			<ul>
				<li class="M">
				...
				<li class="noRight"><a href="module.php">DouJAVA+</a></li>
			</ul>
			<ul class="navRight">
				<li class="M noLeft"><a href="JavaScript:void(0);">您好，admin</a>
					<div class="drop mUser">
						<a href="manager.php?rec=edit&amp;id=1">编辑我的个人资料</a> 
						<a href="cloud.php?rec=account">设置云账户</a>
					</div>
				</li>
